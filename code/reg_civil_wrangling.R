...
deaths_2020 <- deaths_2020 %>% group_by(sexo) %>% summarize(sum(hom)) %>% 
  mutate(year = 2020) 

# 2019
deaths_2019$hom <- hom(deaths_2019$mor_viol)
deaths_2019 <- deaths_2019 %>% group_by(sexo) %>% summarize(sum(hom)) %>% 
  mutate(year = 2019) 

# 2018
deaths_2018$hom <- hom(deaths_2018$mor_viol)
deaths_2018 <- deaths_2018 %>% group_by(sexo) %>% summarize(sum(hom)) %>% 
  mutate(year = 2018) 

# 2017
deaths_2017$hom <- hom(deaths_2017$mor_viol)
deaths_2017 %>% group_by(sexo) %>% summarize(sum(hom)) 
...
deaths_2016 %>% group_by(sexo) %>% summarize(sum(hom))
...
deaths_2015 %>% group_by(sexo) %>% summarize(sum(hom))
...
deaths_2014 %>% group_by(sexo) %>% summarize(sum(hom))
